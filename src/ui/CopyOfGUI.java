...
public class CopyOfGUI extends JPanel implements ActionListener {
	...
	private void getCurrentList(String string) {
		String[] arr= string.split("<br>");
		
		textArea = new JList(arr);
		textArea.setVisibleRowCount(4);
		...
		listPane = new JScrollPane(textArea);
	}
	...
	protected static ImageIcon createImageIcon(String path) {
		java.net.URL imgURL = CopyOfGUI.class.getResource(path);
		if (imgURL != null) {
	...
	private static void createAndShowGUI() throws FileNotFoundException {
		...
		frame.getContentPane().add(new CopyOfGUI());
